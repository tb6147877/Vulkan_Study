...
//}
//
//void MSAA::createSurface() {
//	if (glfwCreateWindowSurface(instance, window, nullptr, &surface) != VK_SUCCESS) {
//		throw std::runtime_error("failed to create window surface!");
//	}
//}
//
//bool MSAA::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
//}
//
//SwapChainSupportDetails MSAA::querySwapChainSupport(VkPhysicalDevice device) {
...
//
//
//VkSurfaceFormatKHR MSAA::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
//
//
//VkPresentModeKHR MSAA::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
//
//
//VkExtent2D MSAA::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
//}
//
//void MSAA::createDescriptorSetLayout() {
...
//
//
//void MSAA::createGraphicsPipeline() {
...
//
//
//VkShaderModule MSAA::createShaderModule(const std::vector<char>& code) {
...
//	colorAttachment.finalLayout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;//msaa开启时就不直接去swapchain了，而是作为一个中间buffer
//
...
//
//	//这个attachment作为拿到swap chain去显示的
...
//
//
//void MSAA::createCommandBuffers() {
...
//}
//
//void MSAA::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
//}
//
//VkCommandBuffer MSAA::beginSingleTimeCommands() {
...
//
//
//void MSAA::endSingleTimeCommands(VkCommandBuffer cmdbuf) {
...
//
//
//void MSAA::updateUniformBuffer(uint32_t currentImage) {
...
//
//
//void MSAA::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
...
//
//
//void MSAA::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
////TODO:编写mipmap生成器
//void MSAA::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLvs) {
...
//
//
//void MSAA::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLvs) {
//	VkCommandBuffer temp_cmdbuf = beginSingleTimeCommands();
//
//	VkImageMemoryBarrier barrier{};
//	barrier.sType = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER;
...
//
//
//void MSAA::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
//	VkCommandBuffer temp_cmdbuf = beginSingleTimeCommands();
//
...
//
//
//bool MSAA::hasStencilComponent(VkFormat format) {
//	return format == VK_FORMAT_D32_SFLOAT_S8_UINT || format == VK_FORMAT_D24_UNORM_S8_UINT;
//}
//
//
//VkFormat MSAA::findDepthFormat() {
...
//
//
//VkFormat MSAA::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features) {
...
//
//
//void MSAA::createTextureImageView() {
//	textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT, mipLevels);
//}
//
//VkImageView MSAA::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLvs) {
//	//创建VkImageView的结构体
...
//
//
//void MSAA::createTextureSampler() {
...
//}
//
//void MSAA::createImage(uint32_t width, uint32_t height, uint32_t mipLvs, VkSampleCountFlagBits numSmps, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
...
//
//
//void MSAA::createDescriptorPool() {
...
//
//
//void MSAA::createDescriptorSets() {
...
//
//
//uint32_t MSAA::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
//}
//
//bool MSAA::isDeviceSuitable(VkPhysicalDevice device) {
...
//}
//
//QueueFamilyIndices MSAA::findQueueFamilies(VkPhysicalDevice device) {
...
//bool MSAA::checkValidationLayerSupport() {
//	uint32_t layerCount;
...
//
////得到Vulkan调试所需的所有扩展
//std::vector<const char*> MSAA::getRequiredExtensions() {
...
//}
//
//void MSAA::framebufferResizeCallback(GLFWwindow* window, int width, int height) {
//	auto app = reinterpret_cast<MSAA*>(glfwGetWindowUserPointer(window));//通过window获取已经绑定好的本类实体
//	app->framebufferResized = true;
//}
//
//void MSAA::setupDebugMessenger() {
...
//}
//
//void MSAA::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
//	createInfo = {};
...
//}
//
//std::vector<char> MSAA::readFile(const std::string& filename) {
