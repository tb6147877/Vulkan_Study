...
//}
//
//void VertexBuffer::pickPhysicalDevice() {
...
//
//
//void VertexBuffer::createLogicalDevice() {
...
//}
//
//void VertexBuffer::createSurface() {
//	if (glfwCreateWindowSurface(instance, window, nullptr, &surface) != VK_SUCCESS) {
//		throw std::runtime_error("failed to create window surface!");
//	}
//}
//
//bool VertexBuffer::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
//}
//
//SwapChainSupportDetails VertexBuffer::querySwapChainSupport(VkPhysicalDevice device) {
...
//
//
//VkSurfaceFormatKHR VertexBuffer::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
//
//
//VkPresentModeKHR VertexBuffer::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
//
//
//VkExtent2D VertexBuffer::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
//
//
//void VertexBuffer::createSwapChain() {
...
//
//
//void VertexBuffer::createImageViews() {
...
//
//
//void VertexBuffer::createGraphicsPipeline() {
...
//
//
//VkShaderModule VertexBuffer::createShaderModule(const std::vector<char>& code) {
...
//
//
//void VertexBuffer::createRenderPass() {
...
//
//
//void VertexBuffer::createFramebuffers() {
...
//
//
//void VertexBuffer::createCommandBuffers() {
...
//
//
//void VertexBuffer::createSyncObjects() {
...
//
//
//void VertexBuffer::recreateSwapChain() {
//	//这里的代码是为了处理窗口的最小化
...
//}
//
//void VertexBuffer::cleanupSwapChain() {
...
//	bufferInfo.size = sizeof(vertices[0]) * vertices.size();//buffer的总大小
//	bufferInfo.usage = VK_BUFFER_USAGE_VERTEX_BUFFER_BIT;//如果是多个用途的话可以用or
//	bufferInfo.sharingMode = VK_SHARING_MODE_EXCLUSIVE;//是否可以被多个queue family同时拥有
//
...
//	allocInfo.allocationSize = memRequirements.size;                                                                 //这个表示能与cpu交互                                          //这个表示与cpu内存放在一起
...
//	}
//
//	vkBindBufferMemory(device, vertexBuffer, vertexBufferMemory, 0);//将分配的内存与buffer绑定，第四个参数是buffer在内存中的偏移
//
//	void* data;
...
//}
//
//bool VertexBuffer::isDeviceSuitable(VkPhysicalDevice device) {
...
//}
//
//QueueFamilyIndices VertexBuffer::findQueueFamilies(VkPhysicalDevice device) {
...
//bool VertexBuffer::checkValidationLayerSupport() {
//	uint32_t layerCount;
...
//
////得到Vulkan调试所需的所有扩展
//std::vector<const char*> VertexBuffer::getRequiredExtensions() {
...
//}
//
//void VertexBuffer::createInstance() {
...
//}
//
//VkBool32 VertexBuffer::debugCallback(
...
//}
//
//void VertexBuffer::framebufferResizeCallback(GLFWwindow* window, int width, int height) {
//	auto app = reinterpret_cast<VertexBuffer*>(glfwGetWindowUserPointer(window));//通过window获取已经绑定好的本类实体
//	app->framebufferResized = true;
//}
//
//void VertexBuffer::setupDebugMessenger() {
...
//}
//
//void VertexBuffer::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
//	createInfo = {};
...
//}
//
//std::vector<char> VertexBuffer::readFile(const std::string& filename) {
