...
//}
//
//void DepthBuffer::pickPhysicalDevice() {
...
//
//
//void DepthBuffer::createLogicalDevice() {
...
//}
//
//void DepthBuffer::createSurface() {
//	if (glfwCreateWindowSurface(instance, window, nullptr, &surface) != VK_SUCCESS) {
//		throw std::runtime_error("failed to create window surface!");
//	}
//}
//
//bool DepthBuffer::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
//}
//
//SwapChainSupportDetails DepthBuffer::querySwapChainSupport(VkPhysicalDevice device) {
...
//
//
//VkSurfaceFormatKHR DepthBuffer::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
//
//
//VkPresentModeKHR DepthBuffer::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
//
//
//VkExtent2D DepthBuffer::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
//
//
//void DepthBuffer::createSwapChain() {
...
//
//
//void DepthBuffer::createImageViews() {
...
//}
//
//void DepthBuffer::createDescriptorSetLayout() {
...
//
//
//void DepthBuffer::createGraphicsPipeline() {
...
//
//
//VkShaderModule DepthBuffer::createShaderModule(const std::vector<char>& code) {
...
//
//
//void DepthBuffer::createRenderPass() {
...
//
//
//void DepthBuffer::createFramebuffers() {
...
//
//
//void DepthBuffer::createCommandPool() {
...
//
//
//void DepthBuffer::createCommandBuffers() {
...
//}
//
//void DepthBuffer::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
//
//
//void DepthBuffer::endSingleTimeCommands(VkCommandBuffer cmdbuf) {
...
//
//
//void DepthBuffer::updateUniformBuffer(uint32_t currentImage) {
...
//
//
//void DepthBuffer::createSyncObjects() {
...
//
//
//void DepthBuffer::recreateSwapChain() {
//	//这里的代码是为了处理窗口的最小化
...
//}
//
//void DepthBuffer::cleanupSwapChain() {
...
//
//
//void DepthBuffer::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
...
//
//
//void DepthBuffer::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
//
//
//void DepthBuffer::createIndexBuffer() {
...
//
//
//void DepthBuffer::createUniformBuffer() {
...
//}
//
//void DepthBuffer::createTextureImage() {
...
//
//
//void DepthBuffer::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
//	VkCommandBuffer temp_cmdbuf = beginSingleTimeCommands();
//
...
//
//
//void DepthBuffer::createTextureImageView() {
//	textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT);
//}
//
//VkImageView DepthBuffer::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
//	//创建VkImageView的结构体
...
//
//
//void DepthBuffer::createTextureSampler() {
...
//
//
//void DepthBuffer::createDescriptorPool() {
...
//
//
//void DepthBuffer::createDescriptorSets() {
...
//}
//
//bool DepthBuffer::isDeviceSuitable(VkPhysicalDevice device) {
...
//}
//
//QueueFamilyIndices DepthBuffer::findQueueFamilies(VkPhysicalDevice device) {
...
//bool DepthBuffer::checkValidationLayerSupport() {
//	uint32_t layerCount;
...
//
////得到Vulkan调试所需的所有扩展
//std::vector<const char*> DepthBuffer::getRequiredExtensions() {
...
//}
//
//void DepthBuffer::createInstance() {
...
//}
//
//VkBool32 DepthBuffer::debugCallback(
...
//}
//
//void DepthBuffer::framebufferResizeCallback(GLFWwindow* window, int width, int height) {
//	auto app = reinterpret_cast<DepthBuffer*>(glfwGetWindowUserPointer(window));//通过window获取已经绑定好的本类实体
//	app->framebufferResized = true;
//}
//
//void DepthBuffer::setupDebugMessenger() {
...
//}
//
//void DepthBuffer::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
//	createInfo = {};
...
//}
//
//std::vector<char> DepthBuffer::readFile(const std::string& filename) {
