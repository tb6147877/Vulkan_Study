...
void IndexBuffer::pickPhysicalDevice() {
...
void IndexBuffer::createLogicalDevice() {
...
void IndexBuffer::createSurface() {
	if (glfwCreateWindowSurface(instance, window, nullptr, &surface) != VK_SUCCESS) {
		throw std::runtime_error("failed to create window surface!");
	}
}

bool IndexBuffer::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
SwapChainSupportDetails IndexBuffer::querySwapChainSupport(VkPhysicalDevice device) {
...
VkSurfaceFormatKHR IndexBuffer::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR IndexBuffer::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D IndexBuffer::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void IndexBuffer::createSwapChain() {
...
void IndexBuffer::createImageViews() {
...
void IndexBuffer::createGraphicsPipeline() {
...
VkShaderModule IndexBuffer::createShaderModule(const std::vector<char>& code) {
...
void IndexBuffer::createRenderPass() {
...
void IndexBuffer::createFramebuffers() {
...
void IndexBuffer::createCommandPool() {
...
void IndexBuffer::createCommandBuffers() {
...
void IndexBuffer::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
void IndexBuffer::createSyncObjects() {
...
void IndexBuffer::recreateSwapChain() {
	//这里的代码是为了处理窗口的最小化
...
void IndexBuffer::cleanupSwapChain() {
...
void IndexBuffer::createVertexBuffer() {
...
bool IndexBuffer::isDeviceSuitable(VkPhysicalDevice device) {
...
QueueFamilyIndices IndexBuffer::findQueueFamilies(VkPhysicalDevice device) {
...
bool IndexBuffer::checkValidationLayerSupport() {
	uint32_t layerCount;
...
//得到Vulkan调试所需的所有扩展
std::vector<const char*> IndexBuffer::getRequiredExtensions() {
...
void IndexBuffer::createInstance() {
...
VkBool32 IndexBuffer::debugCallback(
...
void IndexBuffer::framebufferResizeCallback(GLFWwindow* window, int width, int height) {
	auto app = reinterpret_cast<IndexBuffer*>(glfwGetWindowUserPointer(window));//通过window获取已经绑定好的本类实体
	app->framebufferResized = true;
}

void IndexBuffer::setupDebugMessenger() {
...
void IndexBuffer::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
	createInfo = {};
...
std::vector<char> IndexBuffer::readFile(const std::string& filename) {
