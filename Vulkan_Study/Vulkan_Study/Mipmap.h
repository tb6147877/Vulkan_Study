...
private:
	...
	//创建一张图片
	void createImage(uint32_t width, uint32_t height, uint32_t mipLvs, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory);
