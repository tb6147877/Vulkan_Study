...
//使用glfw来初始化窗口
void SwapChainRecreation::initWindow() {
	glfwInit();
...
void SwapChainRecreation::initVulkan() {
	createInstance();
	setupDebugMessenger();
	createSurface();
	pickPhysicalDevice();
...
void SwapChainRecreation::pickPhysicalDevice() {
...
void SwapChainRecreation::createLogicalDevice() {
...
void SwapChainRecreation::createSurface() {
	if (glfwCreateWindowSurface(instance, window, nullptr, &surface) != VK_SUCCESS) {
		throw std::runtime_error("failed to create window surface!");
	}
}

bool SwapChainRecreation::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
SwapChainSupportDetails SwapChainRecreation::querySwapChainSupport(VkPhysicalDevice device) {
...
VkSurfaceFormatKHR SwapChainRecreation::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR SwapChainRecreation::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D SwapChainRecreation::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void SwapChainRecreation::createSwapChain() {
...
void SwapChainRecreation::createImageViews() {
...
void SwapChainRecreation::createGraphicsPipeline() {
...
VkShaderModule SwapChainRecreation::createShaderModule(const std::vector<char>& code) {
...
void SwapChainRecreation::createRenderPass() {
...
void SwapChainRecreation::createFramebuffers() {
...
void SwapChainRecreation::createCommandPool() {
...
void SwapChainRecreation::createCommandBuffers() {
...
void SwapChainRecreation::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
void SwapChainRecreation::drawFrame() {
...
void SwapChainRecreation::createSyncObjects() {
...
void SwapChainRecreation::recreateSwapChain() {
	//这里的代码是为了处理窗口的最小化
...
void SwapChainRecreation::cleanupSwapChain() {
...
bool SwapChainRecreation::isDeviceSuitable(VkPhysicalDevice device) {
...
QueueFamilyIndices SwapChainRecreation::findQueueFamilies(VkPhysicalDevice device) {
...
void SwapChainRecreation::mainLoop() {
...
void SwapChainRecreation::cleanup() {
...
bool SwapChainRecreation::checkValidationLayerSupport() {
	uint32_t layerCount;
...
//得到Vulkan调试所需的所有扩展
std::vector<const char*> SwapChainRecreation::getRequiredExtensions() {
...
void SwapChainRecreation::createInstance() {
...
VkBool32 SwapChainRecreation::debugCallback(
...
void SwapChainRecreation::framebufferResizeCallback(GLFWwindow* window, int width, int height) {
	auto app = reinterpret_cast<SwapChainRecreation*>(glfwGetWindowUserPointer(window));//通过window获取已经绑定好的本类实体
	app->framebufferResized = true;
}

void SwapChainRecreation::setupDebugMessenger() {
...
void SwapChainRecreation::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
	createInfo = {};
...
std::vector<char> SwapChainRecreation::readFile(const std::string& filename) {
