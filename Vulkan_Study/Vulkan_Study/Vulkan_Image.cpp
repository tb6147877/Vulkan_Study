...
//}
//
//void Vulkan_Image::pickPhysicalDevice() {
...
//
//
//void Vulkan_Image::createLogicalDevice() {
...
//}
//
//void Vulkan_Image::createSurface() {
//	if (glfwCreateWindowSurface(instance, window, nullptr, &surface) != VK_SUCCESS) {
//		throw std::runtime_error("failed to create window surface!");
//	}
//}
//
//bool Vulkan_Image::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
//}
//
//SwapChainSupportDetails Vulkan_Image::querySwapChainSupport(VkPhysicalDevice device) {
...
//
//
//VkSurfaceFormatKHR Vulkan_Image::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
//
//
//VkPresentModeKHR Vulkan_Image::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
//
//
//VkExtent2D Vulkan_Image::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
//
//
//void Vulkan_Image::createSwapChain() {
...
//
//
//void Vulkan_Image::createImageViews() {
...
//}
//
//void Vulkan_Image::createDescriptorSetLayout() {
...
//
//
//void Vulkan_Image::createGraphicsPipeline() {
//	auto vertShaderCode = readFile("D:/Project/Vulkan_Study/Vulkan_Study/Shaders/vert04.spv");
...
//
//
//VkShaderModule Vulkan_Image::createShaderModule(const std::vector<char>& code) {
...
//
//
//void Vulkan_Image::createRenderPass() {
...
//
//
//void Vulkan_Image::createFramebuffers() {
...
//
//
//void Vulkan_Image::createCommandPool() {
...
//
//
//void Vulkan_Image::createCommandBuffers() {
...
//}
//
//void Vulkan_Image::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
//}
//
//VkCommandBuffer Vulkan_Image::beginSingleTimeCommands() {
...
//
//
//void Vulkan_Image::endSingleTimeCommands(VkCommandBuffer cmdbuf) {
...
//
//
//void Vulkan_Image::updateUniformBuffer(uint32_t currentImage) {
...
//
//
//void Vulkan_Image::createSyncObjects() {
...
//
//
//void Vulkan_Image::recreateSwapChain() {
//	//这里的代码是为了处理窗口的最小化
...
//}
//
//void Vulkan_Image::cleanupSwapChain() {
...
//
//
//void Vulkan_Image::createVertexBuffer() {
...
//
//
//void Vulkan_Image::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
...
//
//
//void Vulkan_Image::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
//
//
//void Vulkan_Image::createIndexBuffer() {
...
//
//
//void Vulkan_Image::createUniformBuffer() {
...
//}
//
//void Vulkan_Image::createTextureImage() {
//	int texWidth, texHeight, texChannels;
//	stbi_uc* pixels = stbi_load("D:/Project/Vulkan_Study/Vulkan_Study/Textures/stone_face.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);//STBI_rgb_alpha是强制图片有一个alpha通道
...
//
//
//void Vulkan_Image::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
//	VkCommandBuffer temp_cmdbuf = beginSingleTimeCommands();
//	
...
//
//
//void Vulkan_Image::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
//	VkCommandBuffer temp_cmdbuf = beginSingleTimeCommands();
//
...
//
//
//void Vulkan_Image::createTextureImageView() {
//	textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB);
//}
//
//VkImageView Vulkan_Image::createImageView(VkImage image, VkFormat format) {
//	//创建VkImageView的结构体
...
//
//
//void Vulkan_Image::createTextureSampler() {
...
//}
//
//void Vulkan_Image::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
...
//
//
//void Vulkan_Image::createDescriptorPool() {
...
//
//
//void Vulkan_Image::createDescriptorSets() {
...
//
//
//uint32_t Vulkan_Image::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
//}
//
//bool Vulkan_Image::isDeviceSuitable(VkPhysicalDevice device) {
...
//}
//
//QueueFamilyIndices Vulkan_Image::findQueueFamilies(VkPhysicalDevice device) {
...
//bool Vulkan_Image::checkValidationLayerSupport() {
//	uint32_t layerCount;
...
//
////得到Vulkan调试所需的所有扩展
//std::vector<const char*> Vulkan_Image::getRequiredExtensions() {
...
//}
//
//void Vulkan_Image::createInstance() {
...
//}
//
//VkBool32 Vulkan_Image::debugCallback(
...
//}
//
//void Vulkan_Image::framebufferResizeCallback(GLFWwindow* window, int width, int height) {
//	auto app = reinterpret_cast<Vulkan_Image*>(glfwGetWindowUserPointer(window));//通过window获取已经绑定好的本类实体
//	app->framebufferResized = true;
//}
//
//void Vulkan_Image::setupDebugMessenger() {
...
//}
//
//void Vulkan_Image::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
//	createInfo = {};
...
//}
//
//std::vector<char> Vulkan_Image::readFile(const std::string& filename) {
